...
//         },
//         body: `jdata={"sid":"2003","mname":"studentGrade","studentID":"${studentID}","instituteID":"NITDINSD1506A0000001","stynumber":7}`
//     }

//     const fetchUrl = "https://erp.nitdelhi.ac.in/CampusLynxNITD/CounsellingRequest?sid=2003&refor=StudentSeatingMasterService";
...
const handler = async (req, res) => {
    ...
    for (let i = 1; i <= semNum; i++) {
        ...
        try {
            ...
            console.error(`Error fetching data for stynumber ${i}:`, error);
            results.push({ error: `Failed to fetch data for stynumber ${i}` });
        }
    }
